...
export const EVENT_CONFIG: Record<EventType, EventConfig> = {
  goal: {
    ...
    cardClassName:
      'border-green-500/50 bg-green-500/15 dark:bg-green-500/10',
  },
  ...
  own_goal: {
    ...
    cardClassName:
      'border-red-500/50 bg-red-500/15 dark:bg-red-500/10',
  },
  ...
  yellow_card: {
    ...
    cardClassName:
      'border-yellow-500/50 bg-yellow-400/20 dark:bg-yellow-500/10',
  },
  ...
  substitution: {
    ...
    cardClassName:
      'border-blue-500/50 bg-blue-500/15 dark:bg-blue-500/10',
  },
  ...
  var: {
    ...
    cardClassName:
      'border-purple-500/50 bg-purple-500/15 dark:bg-purple-500/10',
  },
