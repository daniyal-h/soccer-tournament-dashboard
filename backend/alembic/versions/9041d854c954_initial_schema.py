...
def upgrade() -> None:
    ...
    op.create_index('ix_players_last_name_first_name', 'players', ['last_name', 'first_name'], unique=False)
    ...
    op.create_index(op.f('ix_tournaments_external_api_id'), 'tournaments', ['external_api_id'], unique=True)
    ...
    op.create_index('ix_player_stats_tournament_id', 'player_stats', ['tournament_id'], unique=False)
    op.create_index('uq_player_stats_player_tournament_team', 'player_stats', ['player_id', 'tournament_id', 'team_id'], unique=True)
    ...
    op.create_index('ix_standings_tournament_group', 'standings', ['tournament_id', 'group'], unique=False)
    op.create_index('ix_standings_tournament_id', 'standings', ['tournament_id'], unique=False)
    op.create_index('uq_standings_tournament_team', 'standings', ['tournament_id', 'team_id'], unique=True)
    op.create_table('team_players',
    sa.Column('tournament_id', sa.Integer(), nullable=False),
    sa.Column('team_id', sa.Integer(), nullable=False),
    sa.Column('player_id', sa.Integer(), nullable=False),
    sa.Column('squad_number', sa.Integer(), nullable=True),
    sa.Column('position', sa.Enum('GK', 'DEF', 'MID', 'FWD', name='position_type_enum'), nullable=True),
    sa.ForeignKeyConstraint(['player_id'], ['players.id'], ),
    sa.ForeignKeyConstraint(['team_id'], ['teams.id'], ),
    sa.ForeignKeyConstraint(['tournament_id'], ['tournaments.id'], ),
    ...
    sa.ForeignKeyConstraint(['player_id'], ['players.id'], ),
    sa.ForeignKeyConstraint(['secondary_player_id'], ['players.id'], ),
    sa.ForeignKeyConstraint(['team_id'], ['teams.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
